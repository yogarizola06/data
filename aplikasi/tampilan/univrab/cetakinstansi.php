		...
		<div class="panel-header bg-primary-gradient">
			<div class="page-inner py-5">
				<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
					<div>
						<h2 class="text-white pb-2 fw-bold">Cetak</h2>
						<h5 class="text-white op-7 mb-2">Halaman Cetak</h5>
					</div>
			...
			<div class="row mt--2">
				<div class="col-md-12">
					<div class="card full-height">
						<div class="card-body">
							<div class="card-title">Cetak Staff</div>
							<div class="card-category"></div>
							<form method="GET" action="<?php echo URL;?>/index.php/univrab/cetak_pdf_instansi/" target="_blank">
							...
							<div class="card-action">
								<button type="submit" class="btn btn-primary btn-social btn-submit"><i class="fa fa-print"></i> Cetak
								</button>
