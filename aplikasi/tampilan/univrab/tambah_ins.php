						...
						<div class="col-md-12">
							<div class="card">
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="nm_instansi" placeholder="Nama Instansi" required>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card-action">
									<input type="submit" name="btnAddIns" class="btn btn-success" value="Tambah">
